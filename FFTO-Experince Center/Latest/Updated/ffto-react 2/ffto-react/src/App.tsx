...
import CGToolsAssets from './pages/CGToolsAssets';
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/talent-readiness/learning-companion" element={<LearningCompanion />} />
        ...
        <Route path="/genai-adoption/copilot/cg-tools-assets" element={<CGToolsAssets />} />
