...
import pageData from '../data/engineeringExcellence.json';
import { PageContent } from '../types';
import styles from './EngineeringExcellence.module.css';
  ...
  return (
    <div className={styles.container}>
      <div className={styles.pageHeader}>
        <h1 className={styles.pageTitle}>🛠️ Engineering Excellence</h1>
